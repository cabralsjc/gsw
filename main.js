class Test {
    ...
    toNum(text){
            ...
            var traduzido = "";
            //console.log("1"+trad[26].split('')[0]+"1");
    ...
    toText(numero){
        ...
        for (var i = 0; i < retornoSplit.length; i++){
            if(retornoSplit[i] == "_"){
            }else if(retornoSplit[i] != retornoSplit[i+1]){
                    if(cont !== 0){
                        cont++;
        ...
        var trad = [
            {id: "2", nome:"a"},{id: "22", nome:"b"},{id: "222", nome:"c"},
            {id: "3", nome:"d"},{id: "33", nome:"e"},{id: "333", nome:"f"},
            {id: "4", nome:"g"},{id: "44", nome:"h"},{id: "444", nome:"i"},
            {id: "5", nome:"j"},{id: "55", nome:"k"},{id: "555", nome:"l"},
            {id: "6", nome:"m"},{id: "66", nome:"n"},{id: "666", nome:"o"},
            {id: "7", nome:"p"},{id: "77", nome:"q"},{id: "777", nome:"r"}, {id: "7777", nome:"s"},
            {id: "8", nome:"t"},{id: "88", nome:"u"},{id: "888", nome:"v"},
            {id: "9", nome:"w"},{id: "99", nome:"x"},{id: "999", nome:"y"}, {id: "9999", nome:"z"}
...
console.log(MinhaLista.toText("22666_634442633777726444_46667777"));
//console.log(document.getElementById("traduz").textContent);